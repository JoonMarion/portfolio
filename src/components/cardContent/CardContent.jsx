        ...
        <div className="card">
            <div className="avatar-card secondary">
                <div className="text-content">
                    ...
                    cresci. Atualmente sou estagiário na equipe de desenvolvimento na empresa Sea Telecom e acadêmico de
                    Engenharia de Software na Universidade do Estado do Pará. Desde criança sou entusiasta de tudo que
                    envolve tecnologia, do hardware ao software, e hoje, trabalhando como desenvolvedor, tenho plena
